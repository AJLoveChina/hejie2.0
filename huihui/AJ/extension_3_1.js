...
JSON || (JSON = {}), function () {
    ...
    !function (a) {
        var b = {
            ...
            subConsts: {
                ...
                successDes: "订阅列表",
                editHd: "修改订阅设置",
                subFinishDescribe: "订阅成功",
                unsubFinishDescribe: "已取消",
                describe: "订阅的商品",
                plugClass: "deprice",
                editFinishDescribe: "修改成功"
            },
    ...
    "use strict";
    !function (a) {
        var b = "http://zhushou.huihui.cn/", c = "惠惠购物助手，自动比价，查看商品价格走势，让网购不再坑爹！", d = "我刚试用了@惠惠购物助手，能自动在商品页面显示卓越、当当、京东等商城报价，能省钱，挺好的", e = "2610228208", f = "", g = {
            shareTo: function (a, h, i, j, k, l) {
                var m = "";
                switch (a) {
                    case"netease":
                        m = g.shareToNetease(j ? j : b, h ? h : c, i ? i.replace(/@惠惠购物助手/g, "#惠惠购物助手#") : d.replace(/@惠惠购物助手/g, "#惠惠购物助手#"));
                        break;
                    case"qq":
                        m = g.shareToQQ(j ? j : b, h ? h : c, i ? i.replace(/@惠惠购物助手/g, "@youdaogouwu") : d.replace(/@惠惠购物助手/g, "@youdaogouwu"));
                        break;
                    case"sina":
    ...
    var c = youdao, d = youdao._, e = c.require_module("youdao.util"), f = c.require_module("youdao.cache"), g = c.require_module("youdao.consts"), h = c.require_module("youdao.code"), i = {
        getSiteConf: function (a) {
            ...
            if (d.name || (d.name = document.title), ("failed" === d.stock || "" == d.stock) && (d.stock = "无货"), d.price && "failed" !== d.price && (d.price = d.price.replace("，", ",")), f.data && f.data.thisItem.price && (d.itemPrice = f.data.thisItem.price.toString()), f.data && f.data.thisItem.available && (d.itemAvailable = f.data.thisItem.available), f.data && f.data.priceHistoryOneYear) {
    ...
    var yd = youdao, cache = yd.require_module("youdao.cache"), consts = yd.require_module("youdao.consts"), util = yd.require_module("youdao.util"), localCapture = yd.require_module("youdao.localCapture"), name = consts.commonName, _ = yd._, $ = yd.jQuery, tmpl = require("modules/collection/collection.html"), mod = yd.mod, name = "comment", successPop = require("modules/collection/successInCollection.html"), pluginSuccessPop = require("modules/collection/pluginSuccessPop.html"), cancelPop = require("modules/collection/cancelPop.html"), changeExpectPricebox = require("modules/collection/changeExpectPrice.html"), changeExpectPrice = require("modules/collection/changeExpectPrice.js"), conf = {
        ...
        _checkPriceRange: function () {
            ...
            if (0 === $(conf.selectors.addBoxQ).length || !$(conf.selectors.removeBoxQ).length) {
                ...
                e.priceUnit = h.priceunit || "元", d = $(_.template(successPop, e)), collection.paintBox(d, b)
            }
    ...
    return ' <li hui-mod="faq" hui-type="hoverMod" class="hui-shopping-faq hui-fz12">\r\n    <a class="hui-sp hui-sp11" clkAction="BAR_FEEDBACK_MOD_CLICK" href="http://zhushou.huihui.cn/suggest?keyfrom=zhushou_bar_feedback" target="_blank" title="意见反馈">\r\n        <span class="hui-icon-cont"><em class="hui-sp hui-sp8"></em></span><br />\r\n        反馈\r\n    </a>\r\n</li>\r\n'
    ...
    var m = {title: "设置", intro: "根据您的浏览历史，惠惠购物助手为您精选全网最超值的优惠信息，您可以将这些优惠提醒设置为："}, n = {
        $se: d("#" + i.optionsID),
        conf: {
            els: {
                box: ".hui-box-setting",
        ...
        renderBox: function () {
            d(g(d.extend(m, {
                ...
                }, {name: "今日特价", index: "specialOffer", value: "open" === h.localConf.showIncidentallyBuy}]
    ...
    return ' <!--代购begin-->\r\n<% var notWhite = !daigouData.isWhiteCategory || daigouData.isWhiteCategory == "failed"; /*不是白名单*/ %>\r\n\r\n<% var notAvailable = captureInfo.notavailable && captureInfo.notavailable != "failed";  /*缺货*/ %>\r\n\r\n<% var isRetailer = captureInfo.retailerName && captureInfo.retailerName!="failed" &&  captureInfo.retailerName.toLocaleLowerCase().indexOf("amazon") < 0 && (!captureInfo.fulfilledName || (captureInfo.fulfilledName !="failed" && captureInfo.fulfilledName.toLocaleLowerCase().indexOf("amazon") < 0)); /*美亚第三方买家*/ %>\r\n\r\n<% var isAmazon = captureInfo.retailerName && (captureInfo.retailerName.toLocaleLowerCase().indexOf("amazon")>-1 || captureInfo.retailerName == "failed"); /*亚马逊自营*/ %>\r\n\r\n<% var notPrice = daigouData.price == "" || daigouData.price == "failed"; /*没有价格商品*/ %>\r\n\r\n<% var country = daigouData.site && daigouData.site.indexOf("co.jp")>-1 ? "日本" : "美国"; /*没有价格商品*/ %>\r\n\r\n<% var unit = daigouData.site && daigouData.site.indexOf("co.jp")>-1 ? "?" : "$"; /*商品符号*/ %>\r\n\r\n<% var freeShipping = captureInfo.shipping && (captureInfo.shipping.toLocaleLowerCase().replace("無料","free").indexOf("free")>-1 || (daigouData.shippingPrices && daigouData.shippingPrices.localShippingPrice == 0)); /*免运费*/ %>\r\n\r\n<% var isChaoZhong = daigouData.itemWeight > 30000; /*是否超重*/ %>\r\n\r\n<% if(country== "日本"){daigouData.daigouTax=0;}%>\r\n\r\n<% var isJpPrice = country == "日本" && daigouData.price >= 200000 /* 日亚价格超20万 */%>\r\n\r\n<li id="hui-plugin-daigou" class="hui-btn<% if (notWhite || notAvailable || isChaoZhong || notPrice || isJpPrice ){ %> hui-btn-disabled<% } %><% if (isRetailer && !daigouData.isThirdpartyMerchant2Whiten) {%> hui-btn-isretailer <%}%>" hui-plugin-type="clickMod">\r\n<a href="javascript:" target="_blank" <% if(!notWhite && !isRetailer) {%> clkaction="PLUGIN_DAIGOU_BUY_CLICK" hoveraction="PLUGIN_DAIGOU_BUY_HOVER"<% } %> data-log-feature="DAIGOU" outfrom="zhushou_bar_haitao" class="hui-daigou-total-price"\r\n        style="<% if (!daigouData.selectedSize || notPrice) {%> cursor:default <% } %>">\r\n            <i class="hui-new-sp hui-sp-plane"></i>\r\n            <span class="hui-daigou-conversion-title">一键海淘</span>\r\n            <span class="hui-daigou-conversion-price">?<span class="hui-daigou-total-yuan-price"><% if (notPrice){ %>暂无\r\n            <% } else { %><%= parseFloat(daigouData.daigouPrice) + parseFloat(daigouData.daigouTax) %>\r\n            <% } %>\r\n            </span></span>\r\n    </a>\r\n    <div id="hui-daigou-undisposed-aletr-dialog" class="hui-btn-cancel" style="display:none">\r\n        <!--<i class="hui-new-sp"></i>-->\r\n        <span>请选好了商品<strong>颜色尺码</strong>等信息再来点我哦！</span>\r\n    </div>\r\n    <div class="daigou-detail" hui-plugin-type="daigouHover">\r\n        <% if (!daigouData.isWhiteCategory) { %>\r\n        <div class="inner">\r\n            <%= daigouData.tips %>\r\n        </div>\r\n        <% } else if (daigouData.isWhiteCategory == "failed") {%>\r\n        <div class="inner">\r\n            抱歉，该商品未收录，暂时不能海淘，先收藏起来吧~\r\n        </div>\r\n        <% } else if (notAvailable){ %>\r\n        <div class="inner">\r\n            抱歉，该<span class="text-red">商品缺货</span>，暂时无法海淘，请先收藏起来！\r\n        </div>\r\n        <% } else if (isChaoZhong){ %>\r\n        <div class="inner">\r\n            抱歉，该<span class="text-red">商品超重</span>，暂时无法海淘！\r\n        </div>\r\n        <% } else if (isJpPrice) { %>\r\n        <div class="inner">\r\n            抱歉，该<span class="text-red">商品价格过高</span>，存在海关退运风险，暂时无法海淘！\r\n        </div>\r\n        <% } else if (notPrice){ %>\r\n        <div class="inner">\r\n            抱歉，该商品页面<span class="text-red">没有标注价格</span>，暂时无法海淘！\r\n        </div>\r\n        <% } else if (!notPrice){ %>\r\n        <div class="inner">\r\n            <% if (isRetailer && !daigouData.isThirdpartyMerchant2Whiten) {%>\r\n                <p>该商品为第三方销售并承运，可能存在<span class="text-red">发货严重延迟、物流无法跟踪、发错货</span>等等问题。</p>\r\n                <p><span class="text-red">*</span>坚持购买<span class="text-red">风险由您个人承担</span>，惠惠<span class="text-red">不接受此单任何理由的退款和退换货。</span></p>\r\n                <a href="javascript:" target="_blank" clkaction="PLUGIN_DAIGOU_CONFIRM_BUY_CLICK" data-log-raitername="<%=captureInfo.retailerName%>" class="confirm-daigou">坚持购买</a>\r\n            <% } %>\r\n            <% if (daigouData.site.indexOf("6pm") > -1) {%>\r\n                <p class="tips text-green">6pm页面库存、价格更新不及时，订单是缺货或涨价以惠惠通知为准，请留意。</p>\r\n            <% } %>\r\n            <% if (daigouData.isWhiteCategory) { %>\r\n                <p><%= daigouData.tips %></p>\r\n            <% } %>\r\n            <p>\r\n                <span class="fl">商品单价：</span>\r\n                <span class="fr">￥<%= daigouData.itemYuanPrice %><span class="text-gray">（<%if(country=="日本"){%><%= daigouData.itemDollarPrice %>日元<%}else{%><%= unit %><%= daigouData.itemDollarPrice %><%}%>)</span></span>\r\n            </p>\r\n            <p>\r\n                <span class="fl"><%= country %>境内运费：</span>\r\n                <span class="fr">￥<%= daigouData.freightYuanPrice %><% if (daigouData.freightYuanPrice == 0){ %><span class="text-gray">（免运费）</span><% } %></span>\r\n            </p>\r\n            <p>\r\n                <span class="fl">预收转运费：</span>\r\n                <span class="fr">￥<%= daigouData.transferPrice %>\r\n                    多退少不补\r\n                    <span class="hui-new-sp hui-new-help transfer-help">\r\n                        <span>预收转运费，按实际重量多退少不补。<a href="\r\nhttp://www.huihui.cn/help/haitao#q17" target="_blank">查看具体规则</a></span>\r\n                    </span>\r\n                </span>\r\n            </p>\r\n            <p>\r\n                <span class="fl"><%if(country!="日本"){%>预收<%}%>关税：</span>\r\n                <span class="fr">\r\n                    <%if(country=="日本"){%>\r\n                    <a href="http://www.huihui.cn/help/haitao#q9" target="_blank">查看关税策略</a>\r\n                    <%}else{%>\r\n                    ￥<%= daigouData.daigouTax %><% if (daigouData.daigouTax == 0){ %><span class="text-gray">（免关税）</span><%}%><%}%></span>\r\n            </p>\r\n            <p>\r\n                <span class="fl"><strong>惠惠到手价：</strong></span>\r\n                <span class="fr text-red">￥<%= parseFloat(daigouData.daigouPrice) + parseFloat(daigouData.daigouTax) %></span>\r\n            </p>\r\n            <p class="days">\r\n                预计送达时间：<a  class="hui-new-sp hui-new-days transfer-help" href="http://www.huihui.cn/help/haitao#q8" target="_blank"></a><br><%= daigouData.estimateArrivalDate %><br>\r\n                <span>商家发货：<%= daigouData.merchandiseTime %><br>物流配送：<%= daigouData.logisticsTime %></span>\r\n            </p>\r\n        </div>\r\n        <% } %>\r\n    </div>\r\n</li>\r\n<li id="hui-plugin-daigou-promotions" class="daigou-promotions" \r\nstyle="<%if(daigouData.haitaoYouhuiList){%> display:block <%}%>">\r\n    <div class="daigou-promotions-content">\r\n        <span class="daigou-promotions-ico"><span class="ico2"></span></span>\r\n        <span class="ico-yhui">优惠</span>\r\n        <% var youhuiList = daigouData.haitaoYouhuiList %>\r\n        <% _.each(youhuiList,function(ele,idx){ %>\r\n            <% if (!ele.forMobile) {%>\r\n                <p class="yhui">\r\n                    <% if(ele.url){ %>\r\n                        <a href="<%= ele.url %>" target="_blank"><%= ele.title %></a>\r\n                    <% } else { %>\r\n                        <%= ele.title %>\r\n                    <% } %>\r\n                </p>\r\n            <% } else {%>\r\n                <p class="app">\r\n                    <% if(ele.url){ %>\r\n                        <a href="<%= ele.url %>" target="_blank"><%= ele.title %></a>\r\n                    <% } else { %>\r\n                        <%= ele.title %>\r\n                    <% } %><span class="download-app"><em class="download-app-pic"><img src="<%= ele.imgUrl %>" width="200" height="200" alt=""></em></span>\r\n                </p>\r\n            <% }%>\r\n        <% }) %>\r\n    </div>\r\n</li>\r\n<li class="daigou-tip-lists" id="hui-plugin-daigou-tips">\r\n    <% if (daigouData.site.indexOf("amazon") > -1){ %>\r\n    <% if (isAmazon){ %>\r\n    <div class="daigou-tip">\r\n        <i class="hui-new-sp hui-new-ziying"></i>自营\r\n        <div class="daigou-tip-box"><div><%= daigouData.siteNameCn %>自营，值得信赖！</div></div>\r\n    </div>\r\n    <% } else { %>\r\n    <div class="daigou-tip">\r\n        <i class="hui-new-sp hui-new-san"></i>第三方\r\n        <div class="daigou-tip-box"><div>第三方商家，下单请谨慎</div></div>\r\n    </div>\r\n    <% } %>\r\n    <% } %>\r\n    <% if (freeShipping){ %>\r\n    <div class="daigou-tip">\r\n        <i class="hui-new-sp hui-new-free-shipping"></i>免<%= country %>运费\r\n        <div class="daigou-tip-box">\r\n            <div><%= daigouData.siteNameCn %>承接<%= country %>境内物流，用一键海淘，零门槛享受免<%= country %>境内运费！</div>\r\n        </div>\r\n    </div>\r\n    <% } else if(captureInfo.shipping) { %>\r\n    <div class="daigou-tip">\r\n        <i class="hui-new-sp hui-new-shipping"></i><%= country %>运费\r\n        <div class="daigou-tip-box">\r\n            <div>第三方商家承接<%= country %>境内物流，需要支付相应的<%= country %>境内运费哦～</div>\r\n        </div>\r\n    </div>\r\n    <% } %>\r\n    <% if ((captureInfo.hasSizeSelector && captureInfo.hasSizeSelector != "failed") || (captureInfo.goodsSize && captureInfo.goodsSize != "failed")){ %>\r\n    <div class="daigou-tip tip-size">\r\n        <a href="http://www.huihui.cn/help/chima" target="_blank" hoveraction="SIZE_HELP_HOVER">\r\n            <i class="hui-new-sp hui-new-size"></i>尺码帮助\r\n        </a>\r\n        <div class="daigou-tip-box" id="-daigou-size">\r\n        </div>\r\n    </div>\r\n    <% } %>\r\n    <% if (daigouData.promotionData){ %>\r\n    <div class="daigou-tip">\r\n        <i class="hui-new-sp hui-new-cu"></i>促销活动\r\n        <div class="daigou-tip-box"><div><%= daigouData.promotionData.info%></div></div>\r\n    </div>\r\n    <% } %>\r\n    <div class="daigou-tip">\r\n        <i class="hui-new-sp hui-new-translate"></i>翻译帮助\r\n        <div class="daigou-tip-box">\r\n            <div>\r\n                <label class="daigou-tip-lable"><input type="checkbox" id="swipe-translate"<% if (daigouData.swipeTranslate == "open"){ %> checked<% } %>>开启划词翻译</label>\r\n                <% if(country== "日本"){%>\r\n                    <label class="daigou-tip-lable"><input type="checkbox" id="crumb-translate"<% if (daigouData.crumbTranslate == "open"){ %> checked<% } %>>开启商品类别翻译</label>\r\n                <% }%>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</li>';
}), youdao.define("modules/plugin_daigou/plugin_daigou_success.html", function () {
    return ' <div id="hui_plugin_success_in_daigou" class="success-info">\r\n    <span>成功加入到海淘购物车！</span>\r\n    <a href="http://www.huihui.cn/global/cart" target="_blank" class="higligth pull-right">去购物车结算 <i>>></i></a>\r\n</div>'
    ...
    var p = g.data.haitao, q = g.data.thisSite.siteName, r = parseFloat(p.exchange, 10), s = {}, t = d.require_module("youdao.localCapture"), u = t.captureResult || {}, v = "#hui-plugin-daigou", w = "[data-type=shopcart]", x = "#hui-plugin-daigou-tips", y = "#hui-plugin-daigou-promotions", z = (e(v), {
        ...
        initDaigouDom: function (a, b) {
            ...
            0 == a.isWhiteCategory ? h = "PLUGIN_DAIGOU_BLACK_TRIGGER" : "failed" == a.isWhiteCategory ? h = "PLUGIN_DAIGOU_NONE_TRIGGER" : b.retailerName && "failed" != b.retailerName && b.retailerName.toLocaleLowerCase().indexOf("amazon") < 0 && (!b.fulfilledName || "failed" != b.fulfilledName && b.fulfilledName.toLocaleLowerCase().indexOf("amazon") < 0) ? h = "PLUGIN_DAIGOU_THIRD_TRIGGER" : "无货" == b.stock && A.changeSelectBoolean() && (h = "PLUGIN_DAIGOU_SOLDOUT_TRIGGER"), A.sendLog(h), A.changeSelectBoolean() ? (e("#hui-plugin-daigou .hui-daigou-total-price").css("cursor", "pointer"), e("#hui-plugin-daigou").removeClass("hui-plugin-daigou-disabled")) : e("#hui-plugin-daigou .hui-daigou-total-price").removeAttr("href").css("cursor", "default");
            ...
            f = unescape(k.replace(/\\(u[0-9a-fA-F]{4})/gm, "%$1")), h = j.encrypt(f, 4, !0), i = j.encrypt(g.data.thisItem.url, 2, !0), d.ajax({
                ...
                success: function (d) {
                    if (d.haitao && (e.extend(b, d.haitao), b.promotionData = g.data.thisItem.promotionData ? g.data.thisItem.promotionData : "", b.daigouPrice = A.getDaigouPrice(b, c), b.daigouTax = A.getTax(b), b.daigouTax = b.daigouTax.toFixed(0), g.data.outfrom = d.outfrom, g.data.priceHistoryTip && l)) {
                        e.extend(g.data, d);
                        var f = g.data.priceHistoryTip["short"].replace("价格", "");
            ...
            if ("amazon" == q && (h = "美国亚马逊"), "siteName" == a)return h || "";
            e.extend(f, {
            ...
            var b = {};
            return a.crumbs && "failed" != a.crumbs && -1 == a.crumbs.indexOf("Back to search results") && -1 == a.crumbs.indexOf("の検索結果に戻る") ? e.extend(b, {crumbs: a.crumbs.substr(0, 100)}) : a.category && "failed" != a.category ? e.extend(b, {category: a.category.substr(a.category.length - 50, 50)}) : e.extend(b, {
            ...
            return !c.crumbs || "failed" == c.crumbs || c.crumbs.indexOf("の検索結果に戻る") > -1 ? !1 : void d.ajax({
                baseUrl: h.fanyiAPI,
                url: "openapi.do",
                params: {
                    keyfrom: "huihui",
                ...
                success: function (a) {
                    ...
                    var c = ['<div id="tran-crumb">商品类别：', A.translationCrumb, "<i>(惠惠&有道翻译提供)</i>", "</div>"];
    ...
    i = !0, setTimeout(function () {
        ...
        if (a.available) {
            var b = n(a), c = {};
            return ("淘宝网" === a.siteName || "海外购直邮" === a.siteName) && (c.url = a.items[0].cpsUrl, c.price = a.items[0].price), e.data.hasHaiWaiGou && "海外购直邮" !== a.siteName ? !0 : void m.push({
                siteName: a.siteName,
                ...
                var json = {
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (a, b) {
                            if (0 != a) {
                                var c = {};
                                c.price = b.price + "元", c.url = b.curl1, c.imgUrl = b.timg, c.mediavAD = !0, b.hasOwnProperty("pn") ? c.title = b.pn : c.title = "", b.hasOwnProperty("oprice") ? c.maxPrice = b.oprice : c.maxPrice = "", mediav.push(c)
                            }
                        });
    ...
    return h.vendorChoose = function (a) {
        ...
        return h = {
            ...
            d(document).delegate(h.chooseQ, "click.vendor.choose", function () {
                ...
                e.attr("data-value");
                return d(h.shopsChooseed).val("自定义商家"), d(h.chooseQ).attr("data-type", "C"), !e.hasClass("youdaoGWZS_btn-choice") || f && 0 !== f.length ? (e.hasClass("youdaoGWZS_btn-cancel") && (o("cancelAll"), d('.diy-stores input[data-famous="true"]').attr("checked", !0), w[0].famous ? d(h.chooseQ).attr("data-type", "B") : d(h.chooseQ).attr("data-type", "C"), c = r(), d(u).val(c.defaultPrice), d(h.chooseQ).attr("data-result", c.checkedItems), b = d(h.chooseQ + " input")[0], b.value = "惠惠推荐商家"), void d(h.storeListQ).hide()) : void n(h.customBox)
            })
        }, n = function (a) {
            ...
            var a = [], b = [];
            v ? "BELIEVE" === c.listType ? (j = "惠惠推荐商家", m = "") : "CUSTOM" === c.listType ? (j = "自定义商家", m = "") : m = "enable" : w.length > 1 ? (j = "惠惠推荐商家", m = "") : (j = w[0].siteName, m = "enable"), e.each(w, function (c) {
                var d, e;
    ...
    var c = youdao, d = c.jQuery, e = c._, f = c.require_module("youdao.cache"), g = c.require_module("youdao.consts"), h = c.require_module("youdao.code"), i = a("modules/depriceRemind/vendorSelector.js").vendorChoose, j = c.require_module("youdao.util"), k = (c.modules, f.data, c.reg("depriceRemind")), l = a("modules/depriceRemind/miniDepriceRemind.html"), m = a("modules/depriceRemind/depriceRemind.html"), n = function () {
        ...
        var w = function () {
            ...
            b = b || {};
            var c = {ALL: "全部商家", BELIEVE: "惠惠推荐商家", CUSTOM: "自定义商家"}, h = f.data.thisSite.siteName || "当前商家";
        ...
        var B = function () {
            ...
            baseEnv: function () {
                ...
                t.extensionid = j.extensionid || "", t.email = j.email || f.data.email || "", t.remberEmail = !0, t.priceList = [], v.isModify ? (g = v.modifyInfo, t.email = v.email, t.itemId = g.itemId, t.clusterId = g.clusterId || "", t.iscluster = g.iscluster, t.username = g.username, t.yixin_status = g.yixin_status, d.extend(t.priceList, g.priceList)) : (b = f.data.urlPriceList || {}, p.avaiable = m.avaiable, p.price = m.price, p.id = k.id, p.site = l.site, p.famous = l.famous, p.siteName = l.siteName, c = h.encrypt(k.url, 2, !0), t.mmurl = c, t.itemId = k.id, t.clusterId = o.clusterId || "", e.each(b, function (a) {
                    ...
                    isModify: v.isModify
                }), t.currentShop = f.data.thisSite.siteName || "当前商家", t.initPrice = a.initPrice
            }, common: function () {
                v.type;
    ...
    var c = youdao, d = c.jQuery, e = c._, f = c.require_module("youdao.cache"), g = (c.require_module("youdao.consts"), c.require_module("youdao.code"), c.require_module("youdao.util")), h = c.reg("galleryDiscount"), i = {
        ...
        getInforItem: function (a) {
            ...
            switch (g) {
                case"lowest":
                    b = "price-lowest", c = "折", e = "#fff", d = !0;
                    break;
                case"fall":
                    b = "price-decline", c = "折", d = !0, e = "#006f00";
                    break;
                case"steady":
                    b = "price-stable", c = "平稳", e = "#666";
                    break;
                case"rise":
                    b = "price-rise", c = "上涨", e = "#fff";
                    break;
                case"notcheap":
    ...
    var c = youdao, d = c.jQuery, e = (c._, c.require_module("youdao.cache"), {
        SUB: function (a, b) {
            ...
            if (f > 12)var g = "12月前", h = "6月前"; else if (f > 10)var g = "10月前", h = "5月前"; else if (f > 8)var g = "8月前", h = "4月前"; else if (f > 6)var g = "6月前", h = "3月前"; else if (f > 4)var g = "4月前", h = "2月前"; else if (f = 3)var g = "2月前", h = "1月前"; else var g = "4周前", h = "2周前";
    ...
    var c, d = youdao, e = d.jQuery, f = d._, g = window.location, h = g.protocol, i = g.hostname, j = g.pathname, k = d.require_module("youdao.cache"), l = d.require_module("youdao.consts"), m = (d.require_module("youdao.code"), d.require_module("youdao.util")), n = a("modules/runtime/trendCanvas.js"), o = {
        ...
        view: '<div id="youdaoGWZS_hover-tips" style="position:absolute; top:<%= dimensionY %>px;left:<%= dimensionX %>px; "class="clearfix youdaoGWZS_hover-tips<%= type %>"><div class="youdaoGWZS_hover-tips-hd"></div><h3><span class="hui-logo"></span><span>价格预览</span></h3><% if (isShowpromotionBar) {%><div class="hui-trend-Promotion"><p>正参加<span><%= isShowpromotionBar.info %></span><% if (isShowpromotionBar.promoDiscount) {%>，折算<%= isShowpromotionBar.promoDiscount %>折到手价<span><%= priceunitSymbol %><%= isShowpromotionBar.promoPrice %></span><% } %></p></div><% } %><% if (isShowPriceCanvas) { %><div class="hui-trend-canvas"><canvas class="hui-trend-axis" width="240" height="130"></canvas><canvas class="hui-trend-curve" width="240" height="130"></canvas><div class="hui-trend-time-labels"></div><div class="hui-trend-most-price"></div></div><% } else { %><% if (isDataURISupported) { %><img src="data:image/png;base64,<%= img %>" /><% } else { %><img src="<%= url %>" /><% } %><% } %><% if (isShowPriceTrendShare) { %><a class="-price-trend-share hui-price-trend-share" clkAction = "POPUP_HISTORY_TEXT_CLICK" data-log-status="toWeibo"data-log-feature="PROMOTE"href="<%= resultObj.priceTrendShare.shareUrl%>" target="_blank"><i></i><%= resultObj.priceTrendShare.anchor %> </a><% } else { %><a class="-price-trend-share hui-price-trend-share" clkAction = "POPUP_HISTORY_TEXT_CLICK" data-log-status="toWeibo"data-log-feature="PROMOTE"href="<%= resultObj.priceTrendShare.shareUrl%>" target="_blank"><i></i><%= resultObj.priceTrendShare.anchor %></a><% } %><div class="other-vendor-wrapper"><p class="other-vendor-content"style="<% if (!priceInfo.isHaveLowest) { %>margin-top: 12px;<% } %>"> <% if (priceInfo.isHaveLowest) { %><a class="<%= priceInfo.lowestClass %>" target="_blank"clkAction = "POPUP_HISTORY_OTHERS_CLICK" href="<%= priceInfo.clusterUrl %>"><i></i><%= priceInfo.hasLower ? priceInfo.lowestSite : "其他商家最低价" %>：<%= priceInfo.lowestPrice %></a><a class="see-other-vendor" target="_blank" <% if (isShowPriceTrendShare) { %>style="background: none;"<% } %>clkAction = "POPUP_HISTORY_SEEMORE_CLICK" href="<%= priceInfo.clusterUrl %>">去看看<% if (isShowPriceTrendShare) { %>>><% } %></a><% } else { %><span><i></i> 其他商家最低价：暂无</span><% } %></p></div><% if (false) { %><div class="see-guide"><a href="<%= link.target %>" target="_blank"><%= link.anchor %></a><i></i></div><% } %><span class="<%= arrowDirection %> arrow "style="top:<%= arrowVeritical %>px"></span></div>'
    };
    o.trigger()
    ...
    J = "true" == f.localConf.isGray && "maxthon" != f.localConf.browser ? {
        ...
        url: o.serUrl, params: m, context: s, success: function (b) {
            ...
            if (f.data.isShowPriceCanvas) {
                if (f.data && f.data.priceHistoryData) {
                    ...
                    var l = function (a) {
                        ...
                        if (o >= c && (p = !0, c == o ? f.data.priceHistoryTip["short"] = "历史最低" : f.data.priceHistoryTip["short"] = "历史新低", f.data.priceHistoryTip.style = "lowest"), p || (c == k ? (f.data.priceHistoryTip["short"] = "价格平稳", f.data.priceHistoryTip.style = "steady") : c > k ? (f.data.priceHistoryTip["short"] = "价格上涨", f.data.priceHistoryTip.style = "rise") : (f.data.priceHistoryTip["short"] = "价格下降", f.data.priceHistoryTip.style = "fall")), j == n)h[d - 1].price = c; else {
                ...
                var l = function (a) {
                    ...
                    if ((c > k || l >= c) && (c > k && (a = a.replace(/[0-9.]+(?='\smin=')/, c)), l >= c && (n = !0, c == l ? f.data.priceHistoryTip["short"] = "历史最低" : f.data.priceHistoryTip["short"] = "历史新低", f.data.priceHistoryTip.style = "lowest", a = a.replace(/[0-9.]+(?='\sname=')/, c))), n || (c == e ? (f.data.priceHistoryTip["short"] = "价格平稳", f.data.priceHistoryTip.style = "steady") : c > e ? (f.data.priceHistoryTip["short"] = "价格上涨", f.data.priceHistoryTip.style = "rise") : (f.data.priceHistoryTip["short"] = "价格下降", f.data.priceHistoryTip.style = "fall")), m == j)return a.replace(/[0-9.]+(?='\/><\/store>)/, c);
            ...
            var m = "http://shared.ydstatic.com/gouwuex/images/extension_3_1/loading.gif", n = '商品收录中，请稍候<img src="' + m + '">';
            if (f.data.enableHaitao && (n = '价格历史加载中，请稍候<img src="' + m + '">'), K && (n = '商品暂未收录，<a href="javascript:location.reload();">点击刷新</a>重试'), f.data.data && "110000" == f.data.code && !f.data.priceHistory) {
