...
<script>
	...
	try {
		//var aj_is_mobile = null;
		aj.isMobile = function () {
		  var check = false;
		...
		/* if (aj.isMobile() && !/wap.nigeerhuo.com/.test(location.href)) {
			console.log("jump");
			location.href = "http://wap.nigeerhuo.com";
		} */
 	}catch(ex){}	
</script>
...
<script type="text/javascript" src="http://nigeerhuo-public.oss-cn-shanghai.aliyuncs.com/static/js/third-party-js-all.min.txt?ts=20160921"></script>
