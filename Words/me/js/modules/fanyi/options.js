...
/*
 * Thanks to Dongxu Huang,
 * I like your extension ,
 * But I want to improve it to satisfy my requirement.
 * -- AJ  2015-10-24
 */
define(function (require, exports, module) {
    ...
    function translateXML(xmlnode) {
        ...
        if (noBaseTrans == false) {
            translate += "<strong>基本释义:</strong><br/>";
        ...
        return translate + basetrans + webtrans;
    }
...
//        var url = "http://openapi.baidu.com/public/2.0/bmt/translate?q=" + encodeURIComponent(word) + "&client_id=s7C9XO8kYGOOh5AgeTrjyxAG&from=auto&to=auto";
